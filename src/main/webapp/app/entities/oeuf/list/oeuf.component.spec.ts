...
describe('Oeuf Management Component', () => {
  let comp: OeufComponent;
  let fixture: ComponentFixture<OeufComponent>;
  let service: OeufService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'oeuf', component: OeufComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OeufComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.oeufs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
