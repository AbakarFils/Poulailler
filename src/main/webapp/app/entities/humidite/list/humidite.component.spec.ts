...
describe('Humidite Management Component', () => {
  let comp: HumiditeComponent;
  let fixture: ComponentFixture<HumiditeComponent>;
  let service: HumiditeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'humidite', component: HumiditeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HumiditeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.humidites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
