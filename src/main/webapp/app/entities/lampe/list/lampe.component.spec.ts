...
describe('Lampe Management Component', () => {
  let comp: LampeComponent;
  let fixture: ComponentFixture<LampeComponent>;
  let service: LampeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'lampe', component: LampeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LampeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.lampes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
