...
describe('Ventilateur Management Component', () => {
  let comp: VentilateurComponent;
  let fixture: ComponentFixture<VentilateurComponent>;
  let service: VentilateurService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ventilateur', component: VentilateurComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(VentilateurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ventilateurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
