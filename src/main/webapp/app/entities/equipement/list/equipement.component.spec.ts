...
describe('Equipement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'equipement', component: EquipementComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.equipements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
